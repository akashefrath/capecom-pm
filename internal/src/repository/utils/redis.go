...
func (r *Redis) GetUserUuidById(userID int64, userRepo repository.User) (*string, error) {
...
func (r *Redis) GetUserIdByUuid(userUuid string, userRepo repository.User) (*int64, error) {
	userUuidNew, err := GetOrSet(
		context.Background(),
		r,
