...
func (j *Manager) CreateToken(userID string, tokenType TokenType, jti string) (string, int64, error) {
	...
	secondsLeft := int64(time.Until(expirationTime).Seconds())
	return tokenString, secondsLeft, nil
}
